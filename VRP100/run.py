...
def get_logger():
    ...
    log_file = '0123train_PoMtVRS_N100'  

    args.result_dir = os.path.join('result', log_file, args.start_time)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test', dest='test', action='store_true', help="test during train")  # dest='test',
